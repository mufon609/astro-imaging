...
| **ASTAP** | D · CLI zip + DB | SF `astap_command-line_version_Linux_amd64.zip` (2026.06.29) + `d50_star_database.deb` (~850 MB, FOV≥0.6°) | SF SHA-1/MD5 (compute own sha256) | `/opt/astap` | `astap --version` |
