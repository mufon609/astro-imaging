...
ZERO** (`git show 4604c79:TOOLS.md | grep -c`), from one sentence naming all three.
...
- **THE ASTROMETRIC GAIA CATALOGUE IS INSTALLED — this row previously said it was
  ...
  `3a72438` with a hash chain and a functional probe (541 matched stars).
