...
| `solve_audit_corpus.json` | `git show d374450:scripts/qa/member_solve_audit.py` over all 77 members | the wrong-scale member-solve class (ledger `corpus4_member_solve_fix`; guard's register row in BACKLOG:`removal-conditions`) — fix KEPT |
