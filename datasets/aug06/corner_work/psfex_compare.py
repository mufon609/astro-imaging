...
def fit_field(x, y, e1, e2, label, nboot=300):
    ...
    return {"label": label, "n": int(len(x)),
            ...
            "fixed_amplitude_SE_units": flat["fixed_amplitude_SE_units_star_bootstrap"],
            "fixed_direction_deg": flat["fixed_direction_theta0_deg"],
            "radial_R_flat": flat["radial_R"],
            "radial_flat_SE_units": flat["radial_SE_units_star_bootstrap"],
            "radial_R_rho": grow["radial_R"],
            "radial_rho_SE_units": grow["radial_SE_units_star_bootstrap"],
