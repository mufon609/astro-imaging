...
#
#   finish_render.sh <stack.fit> <png-name> [--ra=R --dec=D --radius-deg=N]
#
...
JUDGE=$REPO/results/july14/judge/${NAME}_spcc-linked
...
python3 "$REPO/scripts/calibrate/spcc_run.py" july14 set-01 \
