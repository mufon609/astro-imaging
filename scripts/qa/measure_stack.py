#!/usr/bin/env python3
"""Linear-stack comparison numbers: radial G profile at key radii,
rim-vs-mid deviation, and per-channel rim chroma.

Usage: measure_stack.py <stack.fit> [reference_stack.fit ...]
       [--session=<dir> --set=<name>]  (per-set foreground mask)
